...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  dailyRates: {
    ...
    getByDate: (date: string) => ipcRenderer.invoke('dailyRates:getByDate', date),
  ...
  system: {
    ...
    getBackupDirInfo: () => ipcRenderer.invoke('system:getBackupDirInfo'),
    chooseBackupFolder: (options?: any) => ipcRenderer.invoke('system:chooseBackupFolder', options),
    setBackupFolder: (data: any) => ipcRenderer.invoke('system:setBackupFolder', data),
    resetBackupFolder: () => ipcRenderer.invoke('system:resetBackupFolder'),
